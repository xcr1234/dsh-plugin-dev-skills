...
[`evals/trigger-queries.json`](evals/trigger-queries.json) 是 description 的回归评测集（12 条正例 + 9 条负例）。修改 description 前请先跑评测并记录通过率；方法论（含训练/验证集划分、防过拟合）见 [`evals/README.zh.md`](evals/README.zh.md)。
...
完整步骤见 [examples/README.zh.md](examples/README.zh.md)。
